  ...
  <div className="place-order-container">
    <form action="" className="place-order form" onSubmit={handleSubmit(handleFormSubmit)}>
       <div className="place-order-left">
        ...
        <input className="form-control" type="text" placeholder="Street" {...register('street',{required:true})} />
        ...
        <div className="multi-fields">
            <input className="form-control" type="text" placeholder="Pin Code" {...register('pinCode',{required:true})}/>
            <input className="form-control" type="text" placeholder="Country" {...register('country',{required:true})} />
        </div>
        <input className="form-control" type="number" placeholder="Phone" {...register('phone',{required:true})} />
       </div> 
       ...
       <div className="cart-total">
          ...
          <button type="submit" onClick={()=>navigate('/order')} className="w-50">PROCEED TO PAYMENT</button>
        </div>
       </div>
    </form>
  </div>
